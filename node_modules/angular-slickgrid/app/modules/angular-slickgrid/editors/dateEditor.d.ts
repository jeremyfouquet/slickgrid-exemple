import { Column, ColumnEditor, Editor, EditorArguments, EditorValidator, EditorValidatorOutput, FlatpickrOption, GridOption } from './../models/index';
export declare class DateEditor implements Editor {
    private args;
    private _$inputWithData;
    private _$input;
    private _$editorInputElm;
    private _originalDate;
    private _pickerMergedOptions;
    ...
    readonly editorOptions: FlatpickrOption;
    readonly hasAutoCommitEdit: any;
    readonly pickerOptions: FlatpickrOption;
