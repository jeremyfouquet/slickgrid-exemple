export declare const Sorters: {
     ...
     */
    objectString: import("../models").Sorter;
    /** Sorter method to sort values as regular strings */
    string: import("../models").Sorter;
};
